from TechniqueManager.TechniqueManager import TechniqueManager
from Technique.Technique import Technique, InkjetPrinter, LaserPrinter, CuttingPlotter, Shredder, Companies
